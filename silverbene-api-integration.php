...
define('SILVERBENE_API_VERSION', '1.2.2');
...
require_once SILVERBENE_API_PLUGIN_PATH . 'includes/class-silverbene-whatsapp.php';
...
function silverbene_api_container()
{
    ...
    if (null === $container) {
        ...
        $whatsapp = new Silverbene_WhatsApp();
